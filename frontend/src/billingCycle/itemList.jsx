...
class ItemList extends Component{
    ...
    remove(index){
        if(!this.props.readOnly && this.props.list.length > 1) //se não for leitura e tem que ter 
                                                                //pelo menos um item de crédito
        this.props.arrayRemove('billingCycleForm',this.props.field,index) //id do form, id do field e o indice que quero excluir
    }
...
//credits[0].name nome do primeiro elemento do array de crédtios
